...
/**
 * heap_extract - extracts the root node from a Max Binary
...
/**
 * heapify - rearranges the Heap tree
...
/**
 * last_node_heap - Extracts the last node of the heap.
 * @tree: The current node to operate
 * @level: The current height level
 ...
 * @tree: The root of the tree to calculate height.
 * Return: the tree's height, 0 if NULL.
 */
