 ...
 * @tree: A pointer to the root node measure the height.
...
/**
 * avl_insert_recursive - Inserts a value into a tree recursively.
 * @tree: A double pointer to the root node.
 * @parent: The parent node of the current node.
 * @new: A double pointer to store the node.
 ...
 * @tree: A double pointer to the root node
 * @value: The value to insert
 * Return: A ptr to the inserted node, or NULL
 */
